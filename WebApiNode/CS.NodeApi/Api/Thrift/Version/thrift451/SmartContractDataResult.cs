              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SmartContractMethod _elem80;
                    _elem80 = new SmartContractMethod();
                    _elem80.Read(iprot);
                    Methods.Add(_elem80);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  {
                    string _key83;
                    NodeApi.Variant _val84;
                    _key83 = iprot.ReadString();
                    _val84 = new NodeApi.Variant();
                    _val84.Read(iprot);
                    Variables[_key83] = _val84;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (Methods != null && __isset.methods) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SmartContractMethod _iter85 in Methods)
            {
              _iter85.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (Variables != null && __isset.variables) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter86 in Variables.Keys)
            {
              oprot.WriteString(_iter86);
              Variables[_iter86].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
