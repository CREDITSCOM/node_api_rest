              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SmartContractMethodArgument _elem76;
                    _elem76 = new SmartContractMethodArgument();
                    _elem76.Read(iprot);
                    Arguments.Add(_elem76);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (Arguments != null && __isset.arguments) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SmartContractMethodArgument _iter77 in Arguments)
            {
              _iter77.Write(oprot);
            }
            oprot.WriteListEnd();
