...
namespace NodeApi
{
  ...
  public partial class SmartStateTransInfo : TBase
  {
    ...
    private NodeApi.Amount _executionFee;
    private NodeApi.Variant _returnValue;
    ...
    public NodeApi.Amount ExecutionFee
    {
      get
      {
    ...
    public NodeApi.Variant ReturnValue
    {
      get
      {
        return _returnValue;
          ...
          switch (field.ID)
          {
            ...
            case 2:
              if (field.Type == TType.Struct) {
                ExecutionFee = new NodeApi.Amount();
            ...
            case 3:
              if (field.Type == TType.Struct) {
                ReturnValue = new NodeApi.Variant();
