...
class NodeApi {
    ...
    async GetTransactionInfoRest(id) {

        //  REQUEST ON this.UrlRest
        //for GET request
        let result = {};
        let _url = new URL(`${this.UrlRest}/transaction`);
        let params = { id: id };
        Object
            .keys(params)
        ...
        if (success) {
            ...
            let x = response.then(x => {
                console.log(x);
                result.Id = x.id;
                result.Amount = _this.AmountToStrNew(x);
                result.Source = base58.encode(cs.ConvertCharToByte(x.source));
                result.Receiver = base58.encode(cs.ConvertCharToByte(x.target));
                result.Fee = x.fee;
    ...
    AmountToStrNew(a) {
        if (a.amount_int > 0) {
            return `${a.amount_int}.${(a.amount_fraq / Math.pow(10, 18)).toFixed(12)}`;
        } else {
            return `${(a.amount_fraq / Math.pow(10, 18)).toFixed(12)}`;
        }
...
! function(r) {
    ...
    function e(r, n) { var e = 255 & r[n + 3]; return e = e << 8 | 255 & r[n + 2], e = e << 8 | 255 & r[n + 1], e << 8 | 255 & r[n + 0] }
    ...
    function o(r, n, e) { var t; for (t = 0; t < 4; t++) r[n + t] = 255 & e, e >>>= 8 }

    function i(r, n, e) { r[n] = e.hi >> 24 & 255, r[n + 1] = e.hi >> 16 & 255, r[n + 2] = e.hi >> 8 & 255, r[n + 3] = 255 & e.hi, r[n + 4] = e.lo >> 24 & 255, r[n + 5] = e.lo >> 16 & 255, r[n + 6] = e.lo >> 8 & 255, r[n + 7] = 255 & e.lo }

    function f(r, n, e, t, o) { var i, f = 0; for (i = 0; i < o; i++) f |= r[n + i] ^ e[t + i]; return (1 & f - 1 >>> 8) - 1 }

    function a(r, n, e, t) { return f(r, n, e, t, 16) }

    function u(r, n, e, t) { return f(r, n, e, t, 32) }

    function c(r, t, i, f, a) {
        var u, c, w, y = new Uint32Array(16),
            l = new Uint32Array(16),
            s = new Uint32Array(16),
            h = new Uint32Array(4);
        for (u = 0; u < 4; u++) l[5 * u] = e(f, 4 * u), l[1 + u] = e(i, 4 * u), l[6 + u] = e(t, 4 * u), l[11 + u] = e(i, 16 + 4 * u);
        for (u = 0; u < 16; u++) s[u] = l[u];
        for (u = 0; u < 20; u++) { for (c = 0; c < 4; c++) { for (w = 0; w < 4; w++) h[w] = l[(5 * c + 4 * w) % 16]; for (h[1] ^= n(h[0] + h[3] | 0, 7), h[2] ^= n(h[1] + h[0] | 0, 9), h[3] ^= n(h[2] + h[1] | 0, 13), h[0] ^= n(h[3] + h[2] | 0, 18), w = 0; w < 4; w++) y[4 * c + (c + w) % 4] = h[w] } for (w = 0; w < 16; w++) l[w] = y[w] }
        if (a) { for (u = 0; u < 16; u++) l[u] = l[u] + s[u] | 0; for (u = 0; u < 4; u++) l[5 * u] = l[5 * u] - e(f, 4 * u) | 0, l[6 + u] = l[6 + u] - e(t, 4 * u) | 0; for (u = 0; u < 4; u++) o(r, 4 * u, l[5 * u]), o(r, 16 + 4 * u, l[6 + u]) } else
            for (u = 0; u < 16; u++) o(r, 4 * u, l[u] + s[u] | 0)
    }

    function w(r, n, e, t) { return c(r, n, e, t, !1), 0 }

    function y(r, n, e, t) { return c(r, n, e, t, !0), 0 }
    ...
    function l(r, n, e, t, o, i, f) {
        ...
        for (; o >= 64;) {
            for (w(y, c, f, Br), u = 0; u < 64; u++) r[n + u] = (e ? e[t + u] : 0) ^ y[u];
            for (a = 1, u = 8; u < 16; u++) a = a + (255 & c[u]) | 0, c[u] = 255 & a, a >>>= 8;
            o -= 64, n += 64, e && (t += 64)
        }
        if (o > 0)
            for (w(y, c, f, Br), u = 0; u < o; u++) r[n + u] = (e ? e[t + u] : 0) ^ y[u];
        return 0
    }

    function s(r, n, e, t, o) { return l(r, n, null, 0, e, t, o) }

    function h(r, n, e, t, o) { var i = new Uint8Array(32); return y(i, t, o, Br), s(r, n, e, t.subarray(16), i) }

    function v(r, n, e, t, o, i, f) { var a = new Uint8Array(32); return y(a, i, f, Br), l(r, n, e, t, o, i.subarray(16), a) }

    function g(r, n) { var e, t = 0; for (e = 0; e < 17; e++) t = t + (r[e] + n[e] | 0) | 0, r[e] = 255 & t, t >>>= 8 }

    function b(r, n, e, t, o, i) {
        var f, a, u, c, w = new Uint32Array(17),
        ...
        for (y[3] &= 15, y[4] &= 252, y[7] &= 15, y[8] &= 252, y[11] &= 15, y[12] &= 252, y[15] &= 15; o > 0;) {
            ...
            for (s[u] = 1, t += u, o -= u, g(l, s), a = 0; a < 17; a++)
                for (w[a] = 0, u = 0; u < 17; u++) w[a] = w[a] + l[u] * (u <= a ? y[a - u] : 320 * y[a + 17 - u] | 0) | 0 | 0;
            for (a = 0; a < 17; a++) l[a] = w[a];
            for (c = 0, u = 0; u < 16; u++) c = c + l[u] | 0, l[u] = 255 & c, c >>>= 8;
            for (c = c + l[16] | 0, l[16] = 3 & c, c = 5 * (c >>> 2) | 0, u = 0; u < 16; u++) c = c + l[u] | 0, l[u] = 255 & c, c >>>= 8;
            c = c + l[16] | 0, l[16] = c
        }
        for (u = 0; u < 17; u++) h[u] = l[u];
        for (g(l, Sr), f = 0 | -(l[16] >>> 7), u = 0; u < 17; u++) l[u] ^= f & (h[u] ^ l[u]);
        for (u = 0; u < 16; u++) s[u] = i[u + 16];
        for (s[16] = 0, g(l, s), u = 0; u < 16; u++) r[n + u] = l[u];
        return 0
    }

    function p(r, n, e, t, o, i) { var f = new Uint8Array(16); return b(f, 0, e, t, o, i), a(r, n, f, 0) }

    function _(r, n, e, t, o) { var i; if (e < 32) return -1; for (v(r, 0, n, 0, e, t, o), b(r, 16, r, 32, e - 32, r), i = 0; i < 16; i++) r[i] = 0; return 0 }

    function A(r, n, e, t, o) { var i, f = new Uint8Array(32); if (e < 32) return -1; if (h(f, 0, 32, t, o), 0 !== p(n, 16, n, 32, e - 32, f)) return -1; for (v(r, 0, n, 0, e, t, o), i = 0; i < 32; i++) r[i] = 0; return 0 }

    function U(r, n) { var e; for (e = 0; e < 16; e++) r[e] = 0 | n[e] }

    function E(r) { var n, e; for (e = 0; e < 16; e++) r[e] += 65536, n = Math.floor(r[e] / 65536), r[(e + 1) * (e < 15 ? 1 : 0)] += n - 1 + 37 * (n - 1) * (15 === e ? 1 : 0), r[e] -= 65536 * n }

    function x(r, n, e) { for (var t, o = ~(e - 1), i = 0; i < 16; i++) t = o & (r[i] ^ n[i]), r[i] ^= t, n[i] ^= t }
    ...
    function d(r, n) {
        ...
        for (E(f), E(f), E(f), t = 0; t < 2; t++) {
            for (i[0] = f[0] - 65517, e = 1; e < 15; e++) i[e] = f[e] - 65535 - (i[e - 1] >> 16 & 1), i[e - 1] &= 65535;
            i[15] = f[15] - 32767 - (i[14] >> 16 & 1), o = i[15] >> 16 & 1, i[14] &= 65535, x(f, i, 1 - o)
        }
        for (e = 0; e < 16; e++) r[2 * e] = 255 & f[e], r[2 * e + 1] = f[e] >> 8
    }
    ...
    function B(r) { var n = new Uint8Array(32); return d(n, r), 1 & n[0] }
    ...
    function K(r, n, e) { var t; for (t = 0; t < 16; t++) r[t] = n[t] + e[t] | 0 }

    function Y(r, n, e) { var t; for (t = 0; t < 16; t++) r[t] = n[t] - e[t] | 0 }
    ...
    function L(r, n) { T(r, n, n) }

    function k(r, n) { var e, t = hr(); for (e = 0; e < 16; e++) t[e] = n[e]; for (e = 253; e >= 0; e--) L(t, t), 2 !== e && 4 !== e && T(t, t, n); for (e = 0; e < 16; e++) r[e] = t[e] }

    function z(r, n) { var e, t = hr(); for (e = 0; e < 16; e++) t[e] = n[e]; for (e = 250; e >= 0; e--) L(t, t), 1 !== e && T(t, t, n); for (e = 0; e < 16; e++) r[e] = t[e] }
    ...
    function R(r, n, e) {
        ...
        for (i[31] = 127 & n[31] | 64, i[0] &= 248, S(f, e), o = 0; o < 16; o++) u[o] = f[o], w[o] = a[o] = c[o] = 0;
        for (a[0] = w[0] = 1, o = 254; o >= 0; --o) t = i[o >>> 3] >>> (7 & o) & 1, x(a, u, t), x(c, w, t), K(y, a, c), Y(a, a, c), K(c, u, w), Y(u, u, w), L(w, y), L(l, a), T(a, c, a), T(c, u, y), K(y, a, c), Y(a, a, c), L(u, a), Y(c, w, l), T(a, c, Ar), K(a, a, w), T(c, c, a), T(a, w, l), T(w, u, f), L(u, y), x(a, u, t), x(c, w, t);
        for (o = 0; o < 16; o++) f[o + 16] = a[o], f[o + 32] = c[o], f[o + 48] = u[o], f[o + 64] = w[o];
        var s = f.subarray(32),
            h = f.subarray(16);
        return k(s, s), T(h, h, s), d(r, h), 0
    }

    function P(r, n) { return R(r, n, br) }

    function N(r, n) { return vr(n, 32), P(r, n) }

    function O(r, n, e) { var t = new Uint8Array(32); return R(t, e, n), y(r, gr, t, Br) }

    function C(r, n, e, t, o, i) { var f = new Uint8Array(32); return O(f, o, i), Kr(r, n, e, t, f) }

    function F(r, n, e, t, o, i) { var f = new Uint8Array(32); return O(f, o, i), Yr(r, n, e, t, f) }
    ...
    function M() {
        var r, n, e, t = 0,
            ...
            f = 0,
            a = 65535;
        for (e = 0; e < arguments.length; e++) r = arguments[e].lo, n = arguments[e].hi, t += r & a, o += r >>> 16, i += n & a, f += n >>> 16;
        return o += t >>> 16, i += o >>> 16, f += i >>> 16, new sr(i & a | f << 16, t & a | o << 16)
    }

    function G(r, n) { return new sr(r.hi >>> n, r.lo >>> n | r.hi << 32 - n) }
    ...
    function q(r, n) { var e, t, o = 32 - n; return n < 32 ? (e = r.hi >>> n | r.lo << o, t = r.lo >>> n | r.hi << o) : n < 64 && (e = r.lo >>> n | r.hi << o, t = r.hi >>> n | r.lo << o), new sr(e, t) }
    ...
    function X(r) { return Z(q(r, 28), q(r, 34), q(r, 39)) }

    function D(r) { return Z(q(r, 14), q(r, 18), q(r, 41)) }

    function j(r) { return Z(q(r, 1), q(r, 8), G(r, 7)) }

    function H(r) { return Z(q(r, 19), q(r, 61), G(r, 6)) }
    ...
    function J(r, n, e) {
        ...
        for (var l = 0; e >= 128;) {
            ...
            for (f = 0; f < 80; f++) {
                ...
                for (o = M(w[7], D(w[4]), I(w[4], w[5], w[6]), Tr[f], y[f % 16]), c[7] = M(o, X(w[0]), V(w[0], w[1], w[2])), c[3] = M(c[3], o), a = 0; a < 8; a++) w[(a + 1) % 8] = c[a];
                if (f % 16 === 15)
                    for (a = 0; a < 16; a++) y[a] = M(y[a], y[(a + 9) % 16], j(y[(a + 1) % 16]), H(y[(a + 14) % 16]))
            }
    ...
    function Q(r, n, e) {
        ...
        for (f[e] = 128, e = 256 - 128 * (e < 112 ? 1 : 0), f[e - 9] = 0, i(f, e - 8, new sr(a / 536870912 | 0, a << 3)), J(o, f, e), t = 0; t < 64; t++) r[t] = o[t];
        return 0
    }
    ...
    function $(r, n, e) { var t; for (t = 0; t < 4; t++) x(r[t], n[t], e) }
    ...
    function nr(r, n, e) { var t, o; for (U(r[0], pr), U(r[1], _r), U(r[2], _r), U(r[3], pr), o = 255; o >= 0; --o) t = e[o / 8 | 0] >> (7 & o) & 1, $(r, n, t), W(n, r), W(r, r), $(r, n, t) }
    ...
    function tr(r, n, e) {
        var t, o = new Uint8Array(64),
            i = [hr(), hr(), hr(), hr()];
        for (e || vr(n, 32), Q(o, n, 32), o[0] &= 248, o[31] &= 127, o[31] |= 64, er(i, o), rr(r, i), t = 0; t < 32; t++) n[t + 32] = r[t];
        return 0
    }
    ...
    function fr(r, n, e, t) {
        ...
        for (Q(u, r.subarray(32), e + 32), ir(u), er(w, u), rr(r, w), o = 32; o < 64; o++) r[o] = t[o];
        for (Q(a, r, e + 64), ir(a), o = 0; o < 64; o++) c[o] = 0;
        for (o = 0; o < 32; o++) c[o] = u[o];
        for (o = 0; o < 32; o++)
            for (i = 0; i < 32; i++) c[o + i] += a[o] * f[i];
    ...
    function ur(r, n, e, t) {
        ...
        if (Q(a, r, e), ir(a), nr(c, w, a), er(w, n.subarray(32)), W(c, w), rr(f, c), e -= 64, u(n, 0, f, 0)) { for (o = 0; o < e; o++) r[o] = 0; return -1 }
        for (o = 0; o < e; o++) r[o] = n[o + 64];
        return i = e
    }

    function cr(r, n) { if (r.length !== zr) throw new Error("bad key size"); if (n.length !== Rr) throw new Error("bad nonce size") }

    function wr(r, n) { if (r.length !== Fr) throw new Error("bad public key size"); if (n.length !== Mr) throw new Error("bad secret key size") }
    ...
    function lr(r) { for (var n = 0; n < r.length; n++) r[n] = 0 }
    var sr = function(r, n) { this.hi = 0 | r, this.lo = 0 | n },
        hr = function(r) {
        ...
        vr = function() { throw new Error("no PRNG") },
    ...
    r.lowlevel = { crypto_core_hsalsa20: y, crypto_stream_xor: v, crypto_stream: h, crypto_stream_salsa20_xor: l, crypto_stream_salsa20: s, crypto_onetimeauth: b, crypto_onetimeauth_verify: p, crypto_verify_16: a, crypto_verify_32: u, crypto_secretbox: _, crypto_secretbox_open: A, crypto_scalarmult: R, crypto_scalarmult_base: P, crypto_box_beforenm: O, crypto_box_afternm: Kr, crypto_box: C, crypto_box_open: F, crypto_box_keypair: N, crypto_hash: Q, crypto_sign: fr, crypto_sign_keypair: tr, crypto_sign_open: ur, crypto_secretbox_KEYBYTES: zr, crypto_secretbox_NONCEBYTES: Rr, crypto_secretbox_ZEROBYTES: Pr, crypto_secretbox_BOXZEROBYTES: Nr, crypto_scalarmult_BYTES: Or, crypto_scalarmult_SCALARBYTES: Cr, crypto_box_PUBLICKEYBYTES: Fr, crypto_box_SECRETKEYBYTES: Mr, crypto_box_BEFORENMBYTES: Gr, crypto_box_NONCEBYTES: Zr, crypto_box_ZEROBYTES: qr, crypto_box_BOXZEROBYTES: Ir, crypto_sign_BYTES: Vr, crypto_sign_PUBLICKEYBYTES: Xr, crypto_sign_SECRETKEYBYTES: Dr, crypto_sign_SEEDBYTES: jr, crypto_hash_BYTES: Hr }, r.randomBytes = function(r) { var n = new Uint8Array(r); return vr(n, r), n }, r.secretbox = function(r, n, e) { yr(r, n, e), cr(e, n); for (var t = new Uint8Array(Pr + r.length), o = new Uint8Array(t.length), i = 0; i < r.length; i++) t[i + Pr] = r[i]; return _(o, t, t.length, n, e), o.subarray(Nr) }, r.secretbox.open = function(r, n, e) { yr(r, n, e), cr(e, n); for (var t = new Uint8Array(Nr + r.length), o = new Uint8Array(t.length), i = 0; i < r.length; i++) t[i + Nr] = r[i]; return t.length < 32 ? null : 0 !== A(o, t, t.length, n, e) ? null : o.subarray(Pr) }, r.secretbox.keyLength = zr, r.secretbox.nonceLength = Rr, r.secretbox.overheadLength = Nr, r.scalarMult = function(r, n) { if (yr(r, n), r.length !== Cr) throw new Error("bad n size"); if (n.length !== Or) throw new Error("bad p size"); var e = new Uint8Array(Or); return R(e, r, n), e }, r.scalarMult.base = function(r) { if (yr(r), r.length !== Cr) throw new Error("bad n size"); var n = new Uint8Array(Or); return P(n, r), n }, r.scalarMult.scalarLength = Cr, r.scalarMult.groupElementLength = Or, r.box = function(n, e, t, o) { var i = r.box.before(t, o); return r.secretbox(n, e, i) }, r.box.before = function(r, n) { yr(r, n), wr(r, n); var e = new Uint8Array(Gr); return O(e, r, n), e }, r.box.after = r.secretbox, r.box.open = function(n, e, t, o) { var i = r.box.before(t, o); return r.secretbox.open(n, e, i) }, r.box.open.after = r.secretbox.open, r.box.keyPair = function() {
            ...
            return o
        }, r.sign.detached = function(n, e) { for (var t = r.sign(n, e), o = new Uint8Array(Vr), i = 0; i < o.length; i++) o[i] = t[i]; return o }, r.sign.detached.verify = function(r, n, e) {
            if (yr(r, n, e), n.length !== Vr) throw new Error("bad signature size");
            if (e.length !== Xr) throw new Error("bad public key size");
            var t, o = new Uint8Array(Vr + r.length),
        ...
        function() {
            ...
            if (n && n.getRandomValues) {
                ...
                r.setPRNG(function(r, t) {
                    ...
                    for (o = 0; o < t; o += e) n.getRandomValues(i.subarray(o, o + Math.min(t - o, e)));
            ...
            case 4:
                if (ftype == Thrift.Type.MAP) {
                    ...
                    for (var _i53 = 0; _i53 < _size48; ++_i53) {
                        ...
                        var key54 = null;
                        var val55 = null;
                        key54 = input.readByte().value;
                        val55 = new CumulativeAmount();
                        val55.read(input);
            ...
            case 2:
                if (ftype == Thrift.Type.MAP) {
                    ...
                    for (var _i111 = 0; _i111 < _size106; ++_i111) {
                        ...
                        var key112 = null;
                        var val113 = null;
                        key112 = input.readI64().value;
                        val113 = input.readI32().value;
            ...
            case 3:
                if (ftype == Thrift.Type.LIST) {
                    ...
                    for (var _i137 = 0; _i137 < _size132; ++_i137) {
                        var elem138 = null;
                        elem138 = new SmartContractMethodArgument();
                        elem138.read(input);
            ...
            case 2:
                if (ftype == Thrift.Type.LIST) {
                    ...
                    for (var _i145 = 0; _i145 < _size140; ++_i145) {
                        var elem146 = null;
                        elem146 = new SmartContractMethod();
                        elem146.read(input);
