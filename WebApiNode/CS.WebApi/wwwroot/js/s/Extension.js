...
(function()
{
	function Connect(Ip) {
        ...
        var transport = new Thrift.Transport(Ip);
    ...
    window.SignCS = {
        ...
        CreateTransaction: (Obj) => {
			...
			Obj = CombinObj(DefObj,Obj);
			
			if(Obj.smartContract !== undefined)
			{
				Obj.smartContract = CombinObj(DefSmart,Obj.smartContract);
			}
			...
			else
			{
				...
				var byteCode = Obj._connect.SmartContractCompile(Obj.smartContract.code);
			...
			{
				Trans.amount.fraction = ((Obj.amount - Trans.amount.integral).toFixed(12) * Math.pow(10, 12)).toFixed(12) * 1000000
			}
			else
			{
				Trans.amount.fraction = (Number(Obj.amount).toFixed(12) * Math.pow(10, 12)).toFixed(12) * 1000000
			}
